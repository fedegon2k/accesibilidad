...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthNavIcon = $('<i class="fas fa-angle-left"></i>');
            var $nextMonthNavIcon = $('<i class="fas fa-angle-right"></i>');
        ...
        function createModal(id, title, body, footer) {
            ...
            var $modalHeaderTitle = $('<h4 style="position: fixed; margin-top: -5px;" class="modal-title" id="' + id + '_modal_title">' + title + '</h4>');
